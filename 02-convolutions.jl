...
kernel1 = Kernel.gaussian((1, 1))

# ╔═╡ 38f3e604-c068-46bd-adbe-287a11e9e395
kernel2 = Kernel.sobel()[1]

# ╔═╡ ce984806-24bc-4a7c-a135-c0fe788e0651
kernel[-2, -2]
...
begin
	large_image = load("tree.jpg")
	image = shrink_image(large_image, 5)
end
...
conv_image = (convolve(image, kernel2))
...
# ╔═╡ 745f8c08-222c-440b-8578-24ac4431d94a
gauss_blur()
